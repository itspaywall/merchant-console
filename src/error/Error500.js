...
function Error404(props) {
    ...
    return (
        <Grid container={ true } justify="center" className={ classes.root }>
            <Grid item={ true } lg={ 6 }>
                <img className={ classes.image } src="assets/images/500.png" alt="Error 500" />
                ...
                <Typography variant="subtitle1" color="textSecondary" className={ classes.description }>
                    Just kidding! Looks like we have an internal issue, please try again in a couple of minutes.
                </Typography>

                <Link className={ classes.link } to="/index">Go back to home page</Link>
            </Grid>
        </Grid>
    );
}
